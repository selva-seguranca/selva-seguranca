...
<head>
    ...
    <title>Iniciar Ronda - Selva Seguranca</title>
...
<body class="pb-20">
    ...
    <header class="bg-brand-gray p-4 flex items-center justify-between shadow-md">
        <div class="flex items-center space-x-3">
            ...
            <h1 class="font-semibold text-lg text-white tracking-wide">Area Operacional</h1>
        </div>
    ...
    <div class="p-5">
        ...
        <p class="text-sm text-gray-400 mb-6">Preencha os dados do veiculo antes de iniciar a ronda.</p>
        ...
        <form action="/vigilante/checklist" method="POST" class="space-y-6" enctype="multipart/form-data">
            <div class="bg-brand-gray p-4 rounded-xl border border-gray-800">
                <label class="block text-sm font-medium text-gray-300 mb-2">Veiculo Selecionado</label>
                ...
                <?php if (empty($veiculos)): ?>
                    <p class="mt-3 text-xs text-amber-300">Nenhum veiculo disponivel no banco para iniciar uma ronda.</p>
                <?php endif; ?>
            </div>
            ...
            <div class="bg-brand-gray p-4 rounded-xl border border-gray-800 space-y-4">
                ...
                <div>
                    <label class="block text-sm text-gray-300 mb-2">Combustivel</label>
                    <select name="combustivel" class="w-full bg-black border border-gray-700 text-white rounded-lg p-3 outline-none focus:border-brand-red">
                        ...
                        <option value="reserva">Reserva (Atencao!)</option>
                    </select>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm text-gray-300 mb-2">Iluminacao</label>
    ...
    <div id="maintenanceAlert" class="fixed inset-0 bg-black/90 z-[60] hidden flex-col items-center justify-center p-6 px-4">
        <div class="bg-brand-gray border border-red-500 w-full max-w-sm rounded-2xl p-6 text-center shadow-[0_0_40px_rgba(229,9,20,0.4)]">
            ...
            <h2 class="text-2xl font-bold text-white mb-2">Atencao Necessaria</h2>
            <p id="alertMessage" class="text-gray-300 text-sm mb-6 pb-6 border-b border-gray-700">O veiculo atingiu o limite de quilometragem para troca de oleo preventiva.</p>
        ...
        kmInput.addEventListener('blur', function() {
            ...
            if (kmDigitado >= (proxtroca - 1000)) {
                const text = (kmDigitado >= proxtroca)
                    ? "Atencao: A troca de oleo deste veiculo esta vencida."
                    : `Atencao: A troca de oleo vencera nos proximos ${proxtroca - kmDigitado} KM.`;
